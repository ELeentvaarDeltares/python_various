...
import sys
sys.path.insert(0, r'D:\Desktop\Projects\python_tools')
...
for i in range(0,len(yt)):
    ...
    if i==0:
        ...
        cur=np.c_[cur,data[:,7]]
        cont=np.c_[cont,data[:,8]]
...
for i in range(0,out.shape[1]):
    ...
    make_pyg_3d('C:\\Users\\leentvaa\\python_various\\ERT_Marios\\test3d\\3d__%04d_rho.pyg'%i, new_elec, tt)
